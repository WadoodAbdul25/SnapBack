...
probabilities = model.predict_proba(oneHotEncoding)

# Get the top 3 predictions with highest probabilities
top_3_indices = np.argsort(probabilities[0])[-3:][::-1]  # Get indices of top 3 probabilities
top_3_predictions = model.classes_[top_3_indices]  # Retrieve the actual labels for these indices
